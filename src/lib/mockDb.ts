...
export type Employee = {
  ...
  badge_number: string;
  division_id: string;
  bluetooth_security_code: string;
...
export const users: User[] = [
  { id: 'user-001', full_name: 'Mihai Popescu', email: 'mihai.popescu@firma.ro', password_hash: '$2b$10$hashexemplu',  division_id: 'div-001', is_active: true, created_at: '2024-01-15T09:00:00Z', updated_at: '2024-01-15T09:00:00Z' },
  { id: 'user-002', full_name: 'Elena Ionescu',  email: 'elena.ionescu@firma.ro',  password_hash: '$2b$10$hashexemplu2', division_id: 'div-002', is_active: true, created_at: '2024-01-15T09:05:00Z', updated_at: '2024-01-15T09:05:00Z' },
];
...
export const employees: Employee[] = [
  { id: 'emp-001', last_name: 'Popescu', first_name: 'Mihai', cnp: '1900315350042', photo_url: null, badge_number: 'EMP-20240315', division_id: 'div-001', bluetooth_security_code: 'BT-A1B2C3D4E5F6A1B2', car_plate: 'TM-01-ABC', is_access_active: true, access_granted_by: 'emp-000', access_granted_by_cnp: '1750101350010', access_granted_by_badge: 'ADM-00001', access_granted_at: '2024-03-15T10:00:00Z', created_at: '2024-03-15T10:00:00Z', updated_at: '2025-01-01T08:00:00Z' },
  { id: 'emp-002', last_name: 'Ionescu',  first_name: 'Elena',  cnp: '2850622350018', photo_url: null, badge_number: 'EMP-20240420', division_id: 'div-002', bluetooth_security_code: 'BT-F6E5D4C3B2A1F6E5', car_plate: null,         is_access_active: true, access_granted_by: 'emp-000', access_granted_by_cnp: '1750101350010', access_granted_by_badge: 'ADM-00001', access_granted_at: '2024-04-20T09:30:00Z', created_at: '2024-04-20T09:30:00Z', updated_at: '2025-01-01T08:00:00Z' },
];

export const smartphones: Smartphone[] = [
  { id: 'phone-001', employee_id: 'emp-001', puk_code: 'PUK-MIHAI-2024-XQ7', registered_at: '2024-03-15T10:30:00Z', is_active: true },
  { id: 'phone-002', employee_id: 'emp-002', puk_code: 'PUK-ELENA-2024-ZR9',  registered_at: '2024-04-20T10:00:00Z', is_active: true },
];
